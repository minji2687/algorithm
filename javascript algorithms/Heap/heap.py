...
class Heap:
    ...
    def move_down(self, poped_idx):
        ...
        # case3: 오른쪽 자식노드도 있을 때
            ...
            if self.heap_array[left_child_poped_idx] > self.heap_array[right_child_popped_idx]:
                if self.heap_array[poped_idx] < self.heap_array[left_child_poped_idx]:
                    return True
                else:
                    return False
    ...
    def pop(self):
        ...
        while self.move_down(poped_idx):
            ...
            if right_child_poped_idx > len(self.heap_array):
                if self.heap_array[poped_idx] > self.heap_array[left_child_poped_idx]:
                    self.heap_array[poped_idx], self.heap_array[left_child_poped_idx] = self.heap_array[
                        left_child_poped_idx], self.heap_array[poped_idx]
            ...
            # case3: 오른쪽 자식노드도 있을 때
                ...
                if self.heap_array[left_child_poped_idx] > self.heap_array[right_child_poped_idx]:
                    ...
                    if self.heap_array[poped_idx] < self.heap_array[right_child_poped_idx]:
                        self.heap_array[poped_idx], self.heap_array[right_child_poped_idx] = self.heap_array[
                            right_child_poped_idx], self.heap_array[poped_idx]
